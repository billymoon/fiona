...
const Section = ({ seed }) =>
  <ApiSection heading={<span><small>fiona.fn.</small>weighted and <small>fiona.</small>weight</span>}>
    ...
    <Sample nothing={fiona.weight('clamp', i => i < 0.5 ? 0.5 : i > 0.7 ? 0.7 : i)} input={`

...
const Section = ({ seed }) =>
  <section>
    ...
    <p>The distribution function takes a floating point number from 0-1 and returns a number from 0-1. Bezier easing functions are a nice way to shape your data.</p>
    ...
    fiona(${seed}).array(5, seeded => seeded.distribution(salaryDistribution).number({ min: 10000, max: 100000 })
    `} output={`
    fiona(seed).array(5, seeded => seeded.distribution(require('bezier-easing')(0.5, 0.5, 1, 0)).number({ min: 10000, max: 100000 })
    `} />

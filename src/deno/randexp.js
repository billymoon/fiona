...
const global = {};
// https://github.com/fent/randexp.js/blob/master/build/randexp.min.js
// prettier-ignore
!function (window) {
  var e = function () {
    ...
    }(
      {
          ...
          function u(e, t) {
            ...
            switch (e.type) {
              ...
              case l.GROUP:
                ...
                for (
                  e.remember && void 0 === e.groupNumber &&
                  (e.groupNumber = t.push(null) - 1),
                    i = "",
                    h = 0,
                    c = (n = e.options
                      ? a.call(this, e.options)
                      : e.stack).length;
                  h < c;
                  h++
                ) {
        ...
        2: [function (e, t, n) {
          ...
          r.prototype.overlaps = function (e) {
            ...
            r.prototype.toString = function () {
              return this.low == this.high ? this.low.toString()
              : this.low + "-" + this.high;
            },
              ...
              switch (n = f[i++]) {
                case "\\":
                  switch (n = f[i++]) {
                    ...
                    default:
                      /\d/.test(n)
                        ? h.push({ type: o.REFERENCE, value: parseInt(n, 10) })
        ...
        5: [function (e, t, n) {
          var r = e("./types"),
            ...
            a = function () {
              return [{ type: r.CHAR, value: 95 }, {
                type: r.RANGE,
                from: 97,
                to: 122,
              }, { type: r.RANGE, from: 65, to: 90 }].concat(o());
            },
            s = function () {
              return [
                { type: r.CHAR, value: 9 },
